...
import com.thinking.springbootincation.project.monitor.logininfor.service.LogininforServiceImpl;
...
public class SystemLogUtils {
    ...
    public static void log(String username, String status, String msg, Object... args) {
        ...
        if (CommonConsants.LOGIN_SUCCESS.equals(status) || CommonConsants.LOGOUT.equals(status)) {
            saveOpLog(username, msg, CommonConsants.SUCCESS);
        } else if (CommonConsants.LOGIN_FAIL.equals(status)) {
            saveOpLog(username, msg, CommonConsants.FAIL);
        }
    }
