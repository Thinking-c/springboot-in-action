package com.chargedot.webserviceclient.client;

import com.chargedot.webservice.service.CommonService;
import com.chargedot.webservice.service.CommonServiceImpl;
...
//            System.out.println("result:" + result);
    ...
    public static void client2() {
        ...
        try {
            ...
            Object[] objects = client.invoke("sayHello", "BoB");
    ...
    public static void client3(){
        ...
        CommonServiceImpl commonServiceImplPort = commonService.getCommonServiceImplPort();
        commonServiceImplPort.addStudent(new Student(1, "tom", 23));
        GetAllStudentsResponse.Return allStudents = commonServiceImplPort.getAllStudents();
        List<GetAllStudentsResponse.Return.Entry> entrys = allStudents.getEntry();
        for(GetAllStudentsResponse.Return.Entry entry : entrys){
